...
public class KeyspaceRepository {
    ...
    public List<DataStorage> getTable(String tableName) {
        ...
        List<DataStorage> accountDetails = result.all()
                .stream()
                .map(row -> new DataStorage(row.getInt("accountId"), row.getString("name"),row.getInt("balance")))
    ...
    public String convertToJson(List<DataStorage> accountDetails){
